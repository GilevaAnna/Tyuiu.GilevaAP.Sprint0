using Tyuiu.GilevaAP.Sprint0.Task7.V0.lib;
namespace Tyuiu.GilevaAP.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 |Выполнила: Гилёва А.П. | СМАРТб-26-1";
            Console.WriteLine("***************************************************************************");
            ...
            Console.WriteLine("* одинаковых массивов по длинею                                           *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
